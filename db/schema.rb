...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "flag_defs", :force => true do |t|
    t.string    "flag_type",        :limit => 2,  :default => "", :null => false
    t.string    "flag_value",       :limit => 4,  :default => "", :null => false
    t.string    "flag_name",        :limit => 25
    t.string    "flag_description"
    t.datetime  "created_at"
    t.timestamp "updated_at"
  end

  create_table "gene_priority", :force => true do |t|
    t.integer "priority",  :limit => 6,                  :null => false
  ...
  create_table "oligo_annotations", :force => true do |t|
    t.integer   "oligo_design_id",   :limit => 11,                 :null => false
    t.string    "oligo_name",        :limit => 100
    t.integer   "selector_nr",       :limit => 11
    t.string    "paralog_flag",      :limit => 2
    t.string    "alu_flag",          :limit => 2
    t.string    "wg_repeat_flag",    :limit => 2
    t.string    "other_repeat_flag", :limit => 2
    t.integer   "wg_u0_cnt",         :limit => 11,  :default => 0, :null => false
    t.integer   "wg_u1_cnt",         :limit => 11,  :default => 0, :null => false
    t.integer   "paralog_cnt",       :limit => 11,  :default => 0, :null => false
    t.integer   "version_id",        :limit => 6
    t.string    "genome_build",      :limit => 25
    t.datetime  "created_at"
    t.timestamp "updated_at"
  end

  add_index "oligo_annotations", ["oligo_design_id"], :name => "oa_oligo_design_idx", :unique => true
  ...
  create_table "oligo_plates", :force => true do |t|
    ...
    t.integer  "oligo_conc_um",       :limit => 8
    t.decimal  "te_concentration",                  :precision => 11, :scale => 4
    t.integer  "storage_location_id", :limit => 11
    t.string   "plate_depleted_flag", :limit => 1
    t.string   "available_for_pool",  :limit => 1
    t.string   "comments"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  add_index "oligo_wells", ["synth_oligo_id"], :name => "ow_synth_oligo_fk"
  ...
  create_table "pilot_oligo_designs", :force => true do |t|
    t.string   "oligo_name",              :limit => 100, :default => "", :null => false
    t.integer  "target_region_id",        :limit => 11,  :default => 0
  ...
  create_table "pool_wells", :force => true do |t|
    ...
    t.float    "pool_well_volume",    :limit => 11, :default => 0.0
    t.integer  "nr_oligos",           :limit => 6,  :default => 0
    t.float    "ul_to_pool",          :limit => 9
    t.float    "oligo_concentration", :limit => 11
  ...
  add_index "synth_oligos", ["oligo_name"], :name => "so_oligo_name"
